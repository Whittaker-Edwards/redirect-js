/*!
 * @whittaker-edwards/redirect-js v1.0.0
...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.WERedirect = {}));
   ...
   * @returns {string|null}
   */
  function findParamValue(search, name) {
    const query = normalizeQuery(search);
   ...
   * @returns {string}
   */
  function mergeParams(target, additions) {
   ...
   */
  function preserveParams(target, search, names) {
...
//# sourceMappingURL=we.redirect.umd.js.map
